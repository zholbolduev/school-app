  ...
  return (
    <div className="aboutUs">
      ...
      <div className="aboutUs__wrapper">
        <h2>О нас</h2>
        <div className="aboutUs__wrapper_text">
          <p>
            <b> makers</b> - это Lorem Ipsum is simply dummy text of
          ...
          <p>
            <b>Why do we use it?</b> It is a long established fact
          ...
          <p>
            <b>Where does it come from?</b> Contrary to popular
            ...
            paragraphswordsbyteslistsStart with 'Loremipsum dolor sit
            amet...'
          </p>
        </div>
      </div>
